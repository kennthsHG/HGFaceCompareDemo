...
@interface HGSelectPhotoViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate>

@property (nonatomic,copy) HGSelectPhotoPickerBlock photoBlock;   //-> 回掉
...
@implementation HGSelectPhotoViewController
